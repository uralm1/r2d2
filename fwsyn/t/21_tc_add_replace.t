...
/usr/sbin/tc filter add dev $INTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 192.168.34.23 match ip src 10.15.0.1 match ip sport 3128 0xffff flowid 1:300
...
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 192.168.34.23 match ip src 192.168.12.1 match ip sport 3128 0xffff flowid 1:300
...
/usr/sbin/tc filter add dev $INTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 192.168.34.24 match ip src 10.15.0.1 match ip sport 3128 0xffff flowid 1:301
...
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 192.168.34.24 match ip src 192.168.12.1 match ip sport 3128 0xffff flowid 1:301
...
/usr/sbin/tc filter add dev $INTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 192.168.34.25 match ip src 10.15.0.1 match ip sport 3128 0xffff flowid 1:302
...
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 192.168.34.25 match ip src 192.168.12.1 match ip sport 3128 0xffff flowid 1:302
...
/usr/sbin/tc filter add dev $INTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.4.50 match ip src 10.15.0.1 match ip sport 3128 0xffff flowid 1:300
...
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.4.50 match ip src 192.168.12.1 match ip sport 3128 0xffff flowid 1:300

# 301 451
/usr/sbin/tc class add dev $INTR_IF parent 1:10 classid 1:301 htb quantum 6400 rate 256kbit prio 5
/usr/sbin/tc qdisc add dev $INTR_IF parent 1:301 handle 301: pfifo limit 150
/usr/sbin/tc filter add dev $INTR_IF parent 1:0 protocol ip pref 10 u32 match ip dst 1.2.4.51 flowid 1:301
/usr/sbin/tc filter add dev $INTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.4.51 match ip src 10.15.0.1 match ip sport 3128 0xffff flowid 1:301
/usr/sbin/tc class add dev $EXTR_IF parent 1:10 classid 1:301 htb quantum 6400 rate 256kbit prio 5
/usr/sbin/tc qdisc add dev $EXTR_IF parent 1:301 handle 301: pfifo limit 120
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 10 u32 match ip src 1.2.4.51 flowid 1:301
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.4.51 match ip src 192.168.12.1 match ip sport 3128 0xffff flowid 1:301

# 302 452
/usr/sbin/tc class add dev $INTR_IF parent 1:10 classid 1:302 htb quantum 6400 rate 256kbit prio 5
/usr/sbin/tc qdisc add dev $INTR_IF parent 1:302 handle 302: pfifo limit 150
/usr/sbin/tc filter add dev $INTR_IF parent 1:0 protocol ip pref 10 u32 match ip dst 1.2.4.52 flowid 1:302
/usr/sbin/tc filter add dev $INTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.4.52 match ip src 10.15.0.1 match ip sport 3128 0xffff flowid 1:302
/usr/sbin/tc class add dev $EXTR_IF parent 1:10 classid 1:302 htb quantum 6400 rate 256kbit prio 5
/usr/sbin/tc qdisc add dev $EXTR_IF parent 1:302 handle 302: pfifo limit 120
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 10 u32 match ip src 1.2.4.52 flowid 1:302
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.4.52 match ip src 192.168.12.1 match ip sport 3128 0xffff flowid 1:302
...
/usr/sbin/tc filter add dev $INTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.3.14 match ip src 10.15.0.1 match ip sport 3128 0xffff flowid 1:303
...
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.3.14 match ip src 192.168.12.1 match ip sport 3128 0xffff flowid 1:303
...
/usr/sbin/tc filter add dev $INTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.4.50 match ip src 10.15.0.1 match ip sport 3128 0xffff flowid 1:302
...
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.4.50 match ip src 192.168.12.1 match ip sport 3128 0xffff flowid 1:302
...
/usr/sbin/tc filter add dev $INTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.4.50 match ip src 10.15.0.1 match ip sport 3128 0xffff flowid 1:303
...
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.4.50 match ip src 192.168.12.1 match ip sport 3128 0xffff flowid 1:303
...
/usr/sbin/tc filter add dev $INTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.1.1 match ip src 10.15.0.1 match ip sport 3128 0xffff flowid 1:301
/usr/sbin/tc class add dev $EXTR_IF parent 1:10 classid 1:301 htb quantum 6400 rate 256kbit prio 5
/usr/sbin/tc qdisc add dev $EXTR_IF parent 1:301 handle 301: pfifo limit 120
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 10 u32 match ip src 1.2.1.1 flowid 1:301
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.1.1 match ip src 192.168.12.1 match ip sport 3128 0xffff flowid 1:301

# 302 2
/usr/sbin/tc class add dev $INTR_IF parent 1:10 classid 1:302 htb quantum 6400 rate 256kbit prio 5
/usr/sbin/tc qdisc add dev $INTR_IF parent 1:302 handle 302: pfifo limit 150
/usr/sbin/tc filter add dev $INTR_IF parent 1:0 protocol ip pref 10 u32 match ip dst 1.2.1.2 flowid 1:302
/usr/sbin/tc filter add dev $INTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.1.2 match ip src 10.15.0.1 match ip sport 3128 0xffff flowid 1:302
/usr/sbin/tc class add dev $EXTR_IF parent 1:10 classid 1:302 htb rate 64kbit prio 5
/usr/sbin/tc qdisc add dev $EXTR_IF parent 1:302 handle 302: pfifo limit 120
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 10 u32 match ip src 1.2.1.2 flowid 1:302
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 1.2.1.2 match ip src 192.168.12.1 match ip sport 3128 0xffff flowid 1:302
...
/usr/sbin/tc filter add dev $INTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 192.168.34.45 match ip src 10.15.0.1 match ip sport 3128 0xffff flowid 1:300
/usr/sbin/tc class add dev $EXTR_IF parent 1:10 classid 1:300 htb rate 64kbit prio 5
/usr/sbin/tc qdisc add dev $EXTR_IF parent 1:300 handle 300: pfifo limit 120
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 10 u32 match ip src 192.168.34.45 flowid 1:300
/usr/sbin/tc filter add dev $EXTR_IF parent 1:0 protocol ip pref 4 u32 match ip dst 192.168.34.45 match ip src 192.168.12.1 match ip sport 3128 0xffff flowid 1:300
