...
is($t->app->fw_add_replace({id=>451,ip=>'1.2.4.51',mac=>'44:44:44:44:44:44',defjump=>'DROP',blocked=>1,qs=>2}), 1, 'fw_add_replace1 451 replaced');
...
# 451
-A pipe_in_inet_clients -d 1.2.4.51 -m comment --comment 451 -j MARK --set-mark 2
-A pipe_out_inet_clients -s 1.2.4.51 -m comment --comment 451 -j MARK --set-mark 2
# 452
